...
class ExaSearchAgent:
    ...
    async def start(self):
        """Start the agent."""
        self.running = True
        await self.communication_bus.subscribe("search.exa", self._handle_search_request)
        print(f"Exa Search Agent {self.agent_id} started")
    
    async def stop(self):
        """Stop the agent."""
        self.running = False
        await self.communication_bus.unsubscribe("search.exa", self._handle_search_request)
        print(f"Exa Search Agent {self.agent_id} stopped")
